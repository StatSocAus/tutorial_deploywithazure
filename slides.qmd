...
icon_link <- icon_style(icons_fa$solid$link, fill = "#f0a800", float = "left")
icon_github <- icon_style(icons_fa$brands$github, fill = "#f0a800", float = "left")
icon_plane <- icon_style(icons_fa$solid$`paper-plane`, fill = "#f0a800", float = "left")
